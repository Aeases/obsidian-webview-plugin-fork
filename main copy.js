...
var formEditGate = (contentEl, gateOptions, onSubmit) => {
  ...
  new import_obsidian.Setting(advancedOptions).setName("CSS").setClass("open-gate--form-field--column-big").setDesc("Edit this shit").addTextArea((text) => {
    var _a;
